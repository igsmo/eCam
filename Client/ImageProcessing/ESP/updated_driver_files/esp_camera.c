...
#include "xclk.h"
#if CONFIG_OV2640_SUPPORT   //these are set in menuconfig
#include "ov2640.h"
#endif
...
#define FB_GET_TIMEOUT (4000000 / portTICK_PERIOD_MS) //4000/100
...
camera_fb_t *esp_camera_fb_get()
{
    ...
    camera_fb_t *fb = cam_take(portMAX_DELAY);
